...
- **Devise et paiement** : la page de commande détecte le pays du visiteur (`GET /geo/currency`) pour proposer la devise et les moyens de paiement adaptés (carte/PayPal pour CHF, EUR, USD ; Mobile Money pour XOF), avec conversion en taux de change réel.
